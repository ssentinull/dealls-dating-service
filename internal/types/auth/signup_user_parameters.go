...
func (o *SignupUserParams) BindRequest(c *gin.Context) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body types.SignupUserRequest
...
func (o *SignupUserParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *SignupUserParams) bindXClientID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
